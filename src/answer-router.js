...
const DEEP_BLOCK = [
  ...
  '- Если задача сложная и research-образная (юзер сам говорит «research»/«исследуй», или',
  '  вопрос открытый и без фактов не решается) — СНАЧАЛА вызови `hermes_research` (MCP-тул',
  '  trained-skills) и только НА ОСНОВЕ его результата формируй checklist.md. Не пиши пункты',
  '  чек-листа по догадкам, если Hermes ещё не отработал — чек-лист должен опираться на',
  '  добытые факты, а не предшествовать им.',
  ...
  'и GTD-контроллер доводит до конца. Именно ЗДЕСЬ место тяжёлому research (hermes_research',
  'для одного грунтованного вывода, скил deep-research и большие фоновые Workflow — для',
  'многоисточникового фан-аута) — но копи промежуточные результаты на диск',
