'use strict';
// Shared HH utilities — used by 90-hh.js (MCP), hh-quick.js (runner quick answers),
// hh-negotiations.js (cache + sync), and hh-scoring.js (background scoring).
...
// ─── Callback-based HH API client (used by hh-negotiations.js and server.js routes) ──────────
...
module.exports = { readHhToken, readHhContext, writeHhContext, hhFetch, hhPost, hhTokenPath, hhApiRequest, refreshHhToken };
