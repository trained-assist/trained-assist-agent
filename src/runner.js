...
const {
  getQuickAnswer, verifyQuickAnswerIntent, runQuickAnswer, classifyVacancyPublishIntent, _intents,
  STOP_TASK_INTENT, GTD_STOP_INTENT, ACTIVE_CHECKLIST_INTENT, WAKEUP_INTENT, SKIP_TASK_INTENT,
  PING_INTENT, HELP_INTENT, SESSIONS_INTENT, SESSION_DETAIL_INTENT, USAGE_INTENT,
  SECRETS_LIST_INTENT, SECRETS_LOG_INTENT, CONTEXT_OFF_INTENT, CONTEXT_ON_INTENT,
  PERSONA_INTENT, PROJECT_INTENT,
  HH_MY_VACANCIES_INTENT, HH_FUNNEL_INTENT, HH_RESPONSES_INTENT, HH_ATS_EDITOR_INTENT, HH_REVIEW_PAGE_INTENT, ENGINE_SWITCH_INTENT,
...
module.exports = {
  ...
  // Exported for intent-coverage tests only (sourced from runner-intent-engine)
  _intents,
