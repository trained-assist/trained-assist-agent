    ...
    mcpServers: {
      ...
      'trained-skills': {
        ...
        env: {
          ...
          ...(process.env.ZEROCREDS_ADMIN_TOKEN ? { ZEROCREDS_ADMIN_TOKEN: process.env.ZEROCREDS_ADMIN_TOKEN } : {}),
          ...(process.env.ZEROCREDS_URL         ? { ZEROCREDS_URL:         process.env.ZEROCREDS_URL }         : {}),
