...
function message(event) {
  const text = {
    draining: '⏸ Рестарт запланирован. Жду завершения текущих задач. О начале и результате сообщу сюда.',
    restarting: '🔄 Текущие задачи завершены. Начинаю перезапуск сервера.',
    ready: '✅ Сервер перезапущен, восстановление завершено. Очередь возобновлена.',
    failed: '⚠️ Перезапуск или восстановление не завершены. Очередь сохранена и приостановлена; требуется проверка сервера.',
