...
const SKILLS = [
  ...
  },
  {
    ...
    description: 'Быстрые QR-коды для Школы Ефимовой (Москва): счёт на оплату (покупатель вводит свой ИНН → скачивает PDF-инвойс), форма сбора контактов, редирект-QR. Реквизиты продавца сохраняются один раз через efi_set_profile.',
    requires: 'EFI_QR_URL и EFI_QR_TOKEN в env на VM. Затем efi_set_profile(...) один раз чтобы сохранить ИНН и банковские реквизиты.',
  },
  {
    id: 'api-from-website',
