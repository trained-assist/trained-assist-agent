  ...
  tools: {
    ...
    video_analyze_batch: {
      description:
        ...
        'Синонимы задачи (для поиска): разобрать/проанализировать/оценить видео собеседований и созвонов, ' +
        'расшифровка/расшифровать видео и аудио кандидатов, транскрибация записей, оценка кандидатов по видео, ' +
        'видео-ответы и кружки, обработать пачку роликов, много видео за раз.',
      inputSchema: {
        type: 'object',
        properties: {
          videos: {
