...
const CANDIDATES = [
  {
    ...
    history: {
      neg_id: 'demo-neg-morozov',
      resume_id: 'demo-res-morozov',
      synced_at: hoursAgo(2),
      last_hh_message_at: hoursAgo(2),
      messages: [],
      ats_result: {
        score: 8.2,
        verdict: 'ПРОПУСТИТЬ',
      ...
      message_draft: {
        text: 'Алексей, добрый день! Изучили ваше резюме — опыт с турбинами ТЭС очень подходит. Уточните: работали ли с угольными котлами промышленных объектов? И насколько активно готовы к командировкам в первые месяцы?',
  ...
  },
  {
    ...
    history: {
      neg_id: 'demo-neg-krasnov',
      resume_id: 'demo-res-krasnov',
      synced_at: hoursAgo(3),
      last_hh_message_at: hoursAgo(3),
      messages: [],
      ats_result: {
        score: 5.5,
        verdict: 'УТОЧНИТЬ',
      ...
      message_draft: {
        text: 'Сергей, добрый день! Вы упомянули переход с ГЭС на ТЭС — это требует переобучения. Расскажите подробнее о вашем опыте с паровыми турбинами и как быстро готовы освоить новую специфику?',
        generated_at: hoursAgo(0),
        config_version: 1,
      },
    },
  },
  {
    ...
    history: {
      neg_id: 'demo-neg-kovaleva',
      resume_id: 'demo-res-kovaleva',
      synced_at: hoursAgo(5),
      last_hh_message_at: hoursAgo(5),
      messages: [],
      ats_result: {
        score: 2.5,
        verdict: 'ОТКЛОНИТЬ',
  ...
  // Wave 2
  {
    ...
    history: {
      neg_id: 'demo-neg-smirnov',
      resume_id: 'demo-res-smirnov',
      synced_at: hoursAgo(26),
      last_hh_message_at: hoursAgo(26),
      messages: [],
      ats_result: {
        score: 7.6,
        verdict: 'ПРОПУСТИТЬ',
      ...
      message_draft: {
        text: 'Дмитрий, добрый день! Ваш опыт на ТЭЦ очень релевантен. Обсудим детали: по условиям мы предлагаем офис Краснодар + командировки по РФ. Готовы рассмотреть ваши ожидания по компенсации?',
        generated_at: hoursAgo(0),
        config_version: 1,
      },
    },
  },
  {
    ...
    history: {
      neg_id: 'demo-neg-volkov',
      resume_id: 'demo-res-volkov',
      synced_at: hoursAgo(28),
      last_hh_message_at: hoursAgo(28),
      messages: [],
      ats_result: {
        score: 5.2,
        verdict: 'УТОЧНИТЬ',
  ...
  },
  {
    ...
    history: {
      neg_id: 'demo-neg-zaitsev',
      resume_id: 'demo-res-zaitsev',
      synced_at: hoursAgo(48),
      last_hh_message_at: hoursAgo(48),
      messages: [],
      ats_result: {
        score: 3.0,
        verdict: 'ОТКЛОНИТЬ',
  ...
  // Wave 3
  {
    ...
    history: {
      neg_id: 'demo-neg-petrov',
      resume_id: 'demo-res-petrov',
      synced_at: hoursAgo(74),
      last_hh_message_at: hoursAgo(74),
      messages: [],
      ats_result: {
        score: 8.8,
        verdict: 'ПРОПУСТИТЬ',
      ...
      message_draft: {
        text: 'Николай, добрый день! Ваш опыт на Рефтинской ГРЭС с угольным котлом — именно то, что мы ищем. Готовы обсудить ваши условия по переезду и компенсации. Когда удобно созвониться?',
        generated_at: hoursAgo(0),
        config_version: 1,
      },
    },
  },
  {
    ...
    history: {
      neg_id: 'demo-neg-lebedev',
      resume_id: 'demo-res-lebedev',
      synced_at: hoursAgo(75),
      last_hh_message_at: hoursAgo(75),
      messages: [],
      ats_result: {
        score: 6.5,
        verdict: 'УТОЧНИТЬ',
      ...
      message_draft: {
        text: 'Виктор, добрый день! Хороший опыт с турбинами на ТЭС. Уточните: участвовали ли самостоятельно в разработке рабочих программ ПНР? И как быстро готовы к переезду в Краснодар?',
        generated_at: hoursAgo(0),
        config_version: 1,
      },
    },
