  ...
  tools: {
    ...
    interview_analyze: {
      description:
        ...
        'Синонимы задачи (для поиска): проанализировать/разобрать/оценить кандидата по интервью, ' +
        'оценка собеседования, скоринг кандидата, вердикт по расшифровке, портрет и вопросы рекрутёру.',
      inputSchema: {
        type: 'object',
        properties: {
