// Intent-dispatch engine — extracted from runner.js (Phase 1 refactor).
// Contains all INTENT regex constants, getQuickAnswer(), and the async
// wrappers classifyVacancyPublishIntent(), verifyQuickAnswerIntent(),
// runQuickAnswer(). Zero behaviour changes; pure code movement.
// Runner imports this module and re-exports the public functions.
...
const {
  ...
  hhWherePrompt, hhShowAtsConfig, hhStylePage, hhStatus, readActiveVacancy,
  hhSendPreview, hhSendConfirm, hhSendCancel, hhRejectDryRun, hhRejectConfirm,
  hhRejectCancel, hhBatchEvaluate, hhManualScan,
} = require('./hh-quick');
const {
  readVacancyState, initVacancyState, appendVacancyMessage, writeVacancyState,
  generateVacancyFromMessages, publishVacancyPage, publishToHH, getMissingFields,
} = require('./hh-vacancy');
...
module.exports = {
  ...
  runQuickAnswer,
  classifyVacancyPublishIntent,
  // Individual constants used directly by runner.js (runTask + module.exports)
  STOP_TASK_INTENT,
  GTD_STOP_INTENT,
  ...
  // Exported for intent-coverage tests (matches runner.js _intents shape exactly)
  _intents: {
    HH_MY_VACANCIES_INTENT,
    HH_FUNNEL_INTENT,
    HH_RESPONSES_INTENT,
